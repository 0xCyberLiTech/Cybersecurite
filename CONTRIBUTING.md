# 🤝 Guide de contribution à Cybersecurite

Merci de votre intérêt pour contribuer à ce dépôt dédié à la cybersécurité, Linux et sécurité informatique ! Voici les étapes et bonnes pratiques à suivre :
...
2. **Créez une branche** dédiée à votre contribution :
   ...
   ```
3. **Ajoutez vos modifications** (guides, scripts, corrections, etc.).
...
Merci pour votre contribution à la communauté Cybersecurite !
